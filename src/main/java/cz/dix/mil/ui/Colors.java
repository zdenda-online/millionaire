...
public class Colors {
    ...
    public static final Color SELECTED_ANSWER_BACKGROUND = new Color(255, 170, 0);
    public static final Color SELECTED_ANSWER_TEXT = new Color(0, 0, 0);

    public static final Color CORRECT_ANSWER_BACKGROUND = new Color(150, 220, 0);
    ...
    public static final Color REWARDS_CHECKPOINT_COLOR = new Color(255, 230, 0);
    ...
    public static final Color PHONE_FRIEND_COUNTDOWN = new Color(255, 150, 0);
    public static final Color AUDIENCE_VOTING_TEXT = new Color(255, 150, 0);
